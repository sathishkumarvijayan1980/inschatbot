...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class BasicBot : IBot
    {
        ...
        public const string GetRenewalDate = "InsAutomation_GetRenewalDate";
        public const string GetPolicyDocument = "InsAutomation_GetPolicyDoc";
        ...
        private readonly IStatePropertyAccessor<RenewalState> _renewalStateAccessor;
        private readonly IStatePropertyAccessor<DocumentState> _documentStateAccessor;
        ...
        public BasicBot(BotServices services, UserState userState, ConversationState conversationState, ILoggerFactory loggerFactory)
        {
            ...
            _renewalStateAccessor = _userState.CreateProperty<RenewalState>(nameof(RenewalState));
            _dialogStateAccessor = _conversationState.CreateProperty<DialogState>(nameof(DialogState));
            _documentStateAccessor = _userState.CreateProperty<DocumentState>(nameof(DocumentState));
            ...
            Dialogs.Add(new RenewalDialog(_renewalStateAccessor, loggerFactory));
            Dialogs.Add(new PolicyDocDialog(_documentStateAccessor, loggerFactory));
        }
                    ...
                    switch (dialogResult.Status)
                    {
                        case DialogTurnStatus.Empty:
                            switch (topIntent)
                            {
                                ...
                                case GetRenewalDate:
                                    await dc.BeginDialogAsync(nameof(RenewalDialog));
                                    break;

                                case GetPolicyDocument:
                                    await dc.BeginDialogAsync(nameof(PolicyDocDialog));
                                    break;
